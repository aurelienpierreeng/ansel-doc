...
You may choose to automatically apply just the vertical corrections ![vertical-icon](icon-vertical.png#icon), just the horizontal corrections ![horizontal-icon](icon-horizontal.png#icon), or both together ![both-icon](icon-both.png#icon). Ctrl+click on any of the icons to apply a rotation without the lens shift. Shift+click on any of the icons to apply the lens shift without any rotation.
...
![prespective-correction-example-before](perspective-correction-example-before.png#w66)
...
![prespective-correction-example-after](perspective-correction-example-after.png#w66)
