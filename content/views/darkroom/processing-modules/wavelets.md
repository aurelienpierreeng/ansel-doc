...
![wavelets-overview](wavelets-overview.png#w50)
...
![wavelets-retouch-gui](clean-retouch.png#w33)
...
![wavelets-layer-scale-2](wavelets-layer-scale-2.png#w50)

At scales #5 and #6 we begin to see larger and larger features:

![wavelets-layer-scale-5](wavelets-layer-scale-5.png#w50)

![wavelets-layer-scale-6](wavelets-layer-scale-6.png#w50)

By scale #8 we only see very high-level features such as the overall shape of the model's nose, eye and cheek:

![wavelets-layer-scale-8](wavelets-layer-scale-8.png#w50)
...
![wavelets-original](wavelets-original.png#w50)

![wavelets-layer-scale-5](wavelets-layer-scale-5.png#w50)

![wavelets-blur-layered](wavelets-blur-layered.png#w50)
