...
: The blend mode, opacity and [masking](masking-and-blending/masks/_index.md) controls for whichever module currently has focus. Shapes themselves are created and managed from the separate [shape manager](../../views/toolboxes/shape-manager.md) window, opened from the [bottom toolbar](#bottom-panel).
...
[Shape manager](../../views/toolboxes/shape-manager.md)
