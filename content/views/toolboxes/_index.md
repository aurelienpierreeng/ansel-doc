...
- [Shape manager](shape-manager.md) — draw, group and rename every [drawn shape](../darkroom/masking-and-blending/masks/drawn.md) of an image, and choose which modules apply each of them.
